...
Теперь определимся, что нам нужно в первую очередь.  
...
Ссылка на [дашборд](https://public.tableau.com/views/ClanStatistics/ClanRaids) в Tableau Public. Однако, тут отстутсвуют некоторые рейды из-за моей невнимательности, так как у меня либо не было времени запускать сервер Airflow, либо я просто забывал это делать.
### Итоги мини-проекта
...
## dbt
Ссылка на репозиторий, где попробовал сделать ETL pipelinе по формированию витрины данных по продажам на основе данных из файла [Sample Superstore](https://github.com/f0rest-mAker/DataLearn/blob/main/DE-101/Module1/Sample%20-%20Superstore%20-%20Dashboard.xlsx).
