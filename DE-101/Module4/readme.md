...
Ссылка на [дашборд] (пока находиться в стадии фиксов, нужно добавить версию для телефона) в Tableau Public. Однако, тут отстутсвуют некоторые рейды из-за моей невнимательности, так как у меня либо не было времени запускать сервер Airflow, либо я просто забывал это делать.
### Итоги мини-проекта
