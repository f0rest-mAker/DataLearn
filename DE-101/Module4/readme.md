...
Ссылка на [дашборд](https://public.tableau.com/app/profile/ruzal.ibragimov/viz/ClanStatistics/ClanRaids) в Tableau Public. Однако, тут отстутсвуют некоторые рейды из-за моей невнимательности, так как у меня либо не было времени запускать сервер Airflow, либо я просто забывал это делать.
### Итоги мини-проекта
...
## dbt
Теперь переходим к изучению dbt.
